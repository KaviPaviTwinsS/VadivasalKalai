...
// Bind the player to the view.
        ...
        exo_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Utils.finishActivitySlide(VideoFullScreenActivity.this);
            }
        });

        if (getIntent() != null) {
            if (getIntent().getStringExtra("videos") != null) {
                videos = (getIntent().getStringExtra("videos"));
                position=getIntent().getIntExtra("pos",0);
              }
            if (videos != null) {
              //  recyclerview.setAdapter(new VideoAdapter(this, videos, 3, this));
...
//FOR LIVESTREAM LINK:
        ...
        System.out.println("kkkk___" + videos);
        MediaSource videoSource = new ExtractorMediaSource(Uri.parse(videos),
