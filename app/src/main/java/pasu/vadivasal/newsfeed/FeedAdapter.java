...
import pasu.vadivasal.*;
import pasu.vadivasal.MainActivity;
import pasu.vadivasal.view.LoadingFeedItemView;
    ...
    private void setupClickableViews(final View view, final CellFeedViewHolder cellFeedViewHolder) {
        ...
        cellFeedViewHolder.ivFeedCenter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (context instanceof pasu.vadivasal.MainActivity) {
                    ((pasu.vadivasal.MainActivity) context).showLikedSnackbar();
                }
            }
        });
    ...
    public  class CellFeedViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindView(FeedItem feedItem) {
            ...
            if(adapterPosition%2==0)
                Picasso.with(context).load("https://firebasestorage.googleapis.com/v0/b/jallikattu-1a841.appspot.com/o/IMG_3590%5B1%5D.JPG?alt=media&token=60a6691c-4d39-4f5d-955f-29859a36139b").fit().into(ivFeedCenter);
            else
                Picasso.with(context).load("https://firebasestorage.googleapis.com/v0/b/jallikattu-1a841.appspot.com/o/IMG_3593%5B1%5D.JPG?alt=media&token=ad7c8268-ceb0-42a5-bdfe-0fca8fd4279b").fit().into(ivFeedCenter);
