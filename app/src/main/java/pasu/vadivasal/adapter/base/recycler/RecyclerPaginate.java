...
public final class RecyclerPaginate extends Paginate {
    ...
    private final int notifyScrollThreshold;
    private WrapperAdapter wrapperAdapter;
    private WrapperSpanSizeLookup wrapperSpanSizeLookup;
    private boolean viewScrolledNotified;
    ...
    RecyclerPaginate(RecyclerView recyclerView,
                     ...
                     LoadingListItemSpanLookup loadingListItemSpanLookup, int notifyScrollThreshold) {
        this.recyclerView = recyclerView;
        this.callbacks = callbacks;
        this.loadingTriggerThreshold = loadingTriggerThreshold;
        this.notifyScrollThreshold = notifyScrollThreshold;
    ...
    void checkEndOffset() {
        ...
        System.out.println("_________"+firstVisibleItemPosition);

        //Check need to move top
        if (firstVisibleItemPosition == 0) {
            callbacks.inStart();
        } else if (firstVisibleItemPosition == notifyScrollThreshold) {
            callbacks.viewScrolled();
        }
    ...
    public static class Builder {
        ...
        private int notifyScrollThreshold=6;
        ...
        public Builder setNotifyScrollThreshold(int threshold) {
            this.notifyScrollThreshold = threshold;
            return this;
        }
        ...
        public Paginate build() {
            ...
            return new RecyclerPaginate(recyclerView, callbacks, loadingTriggerThreshold, addLoadingListItem,
                    loadingListItemCreator, loadingListItemSpanLookup,notifyScrollThreshold);
        }
    }
