...
import pasu.vadivasal.tournament.data.StaisticsData;
...
public class StatisticsAdapter extends RecyclerView.Adapter<StatisticsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(StatisticsAdapter.ViewHolder viewHolder, int i) {
        ...
        //Picasso.with(context).load(imagedata.get(i).getStaisticsDataUrl()).placeholder(R.drawable.ic_bull_logo).resize(240, 120).into(viewHolder.img_android);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            statistics_count =  view.findViewById(R.id.statistics_count);
