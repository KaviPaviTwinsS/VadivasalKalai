...
public class FeedItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.getItemViewType() == PostAdapter.VIEW_TYPE_DEFAULT) {
            if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
                lastAddAnimatedItem++;
                runEnterAnimation((PostAdapter.ViewHolder) viewHolder);
                return false;
            }
        }
    ...
    private void runEnterAnimation(final PostAdapter.ViewHolder holder) {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof FeedItemHolderInfo) {
            ...
            PostAdapter.ViewHolder holder = (PostAdapter.ViewHolder) newHolder;

            animateHeartButton(holder);
            updateLikesCounter(holder, holder.getFeedItem().likesCount);

            if (PostAdapter.ACTION_LIKE_IMAGE_CLICKED.equals(feedItemHolderInfo.updateAction)) {
    ...
    private void animateHeartButton(final PostAdapter.ViewHolder holder) {
        ...
        bounceAnimY.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                if (PostAdapter.model.stars.containsKey(FirebaseAuth.getInstance().getCurrentUser().getUid())){
    ...
    private void updateLikesCounter(PostAdapter.ViewHolder holder, int toValue) {
    ...
    public void animatePhotoLike(final PostAdapter.ViewHolder holder) {
    ...
    private void dispatchChangeFinishedIfAllAnimationsEnded(PostAdapter.ViewHolder holder) {
    ...
    private void resetLikeAnimationState(PostAdapter.ViewHolder holder) {
